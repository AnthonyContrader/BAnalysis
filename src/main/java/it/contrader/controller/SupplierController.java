...
public class SupplierController implements Controller {
	...
	private static String sub_package = "supplier.";
	...
	public void doControl(Request request) {
		...
		case "READ":
			...
			MainDispatcher.getInstance().callView(sub_package + "SupplierRead", request);
			break;
		...
		case "INSERT":
			...
			MainDispatcher.getInstance().callView(sub_package + "SupplierInsert", request);
			break;
		...
		case "SUPPLIERLIST":
			...
			MainDispatcher.getInstance().callView("Supplier", request);
			break;
		...
		case "GETCHOICE":
			...
			case "L":
				MainDispatcher.getInstance().callView(sub_package + "SupplierRead", null);
				break;
				
			case "I":
				MainDispatcher.getInstance().callView(sub_package + "SupplierInsert", null);
				break;
